...
/**
 * An Affordance for flying to Tatooine
 * 
 * The affordance is offered by the Millennium Falcons on the Rebel Base and the DeathStar
 * <code>RebelFalcon</code> and <code>DeathStarFalcon</code>
 *
 * Teleports Luke and his party to the Millennium Falcon on the other maps
 *
 * @author Daryl Ho
 */
public class flyToTatooine extends SWAffordance implements SWActionInterface {
	...
	public void act(SWActor a) {
		...
		a.say(a.getShortDescription() + " has flown to Tatooine.");
	}
