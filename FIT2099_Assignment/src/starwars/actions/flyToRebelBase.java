...
/**
 * An Affordance for flying to the Rebel Base
 * 
 * The affordance is offered by the Millennium Falcons on Tatooine and the DeathStar
 * <code>TatooineFalcon</code> and <code>DeathStarFalcon</code>
 *
 * Teleports Luke and his party to the Millennium Falcon on the other maps
 *
 * @author Daryl Ho
 */
public class flyToRebelBase extends SWAffordance implements SWActionInterface {

	public flyToRebelBase(SWEntityInterface theTarget, MessageRenderer m) {
		super(theTarget, m);
	...
	public void act(SWActor a) {
		...
		// Change current grid to Rebel Base
		SWWorld world = a.getWorld();
		world.setCurrentGrid(1);
		...
		a.say(a.getShortDescription() + " has flown to the Rebel Base.");
	}
	
	@Override
	public String getDescription() {
		return "Fly to Rebel Base";
	}
}
